...
const aes256 = {
  ...
  //   s[0] = (0xff & (s[0] >> 24)) | (0xff & (s[0] >> 16)) | (0xff & (s[0] >>  8)) | (0xff & (s[0] >>  0));
  //   s[1] = (0xff & (s[1] >> 16)) | (0xff & (s[1] >>  8)) | (0xff & (s[1] >>  0)) | (0xff & (s[1] >>  8));
  //   s[0] = (0xff & (s[2] >>  8)) | (0xff & (s[2] >>  0)) | (0xff & (s[2] >> 16)) | (0xff & (s[2] >> 16));
  //   s[0] = (0xff & (s[3] >>  0)) | (0xff & (s[3] >> 24)) | (0xff & (s[3] >> 24)) | (0xff & (s[3] >> 24));

  //   const e0 = te0[0xff & (s[0] >> 24)] ^ te1[0xff & (s[1] >> 24)] ^ te2[0xff & (s[2] >> 24)] ^ te3[0xff & (s[3] >> 24)];
  //   const e1 = te0[0xff & (s[0] >> 16)] ^ te1[0xff & (s[1] >> 16)] ^ te2[0xff & (s[2] >> 16)] ^ te3[0xff & (s[3] >> 16)];
  //   return [e0 ^ k[0], e1, e2, e3];
  // },
  decrypt: function() {},
...
const expectedRoundKeys = new Uint32Array([
  0x00010203, 0x04050607, 0x08090a0b, 0x0c0d0e0f, 
  0x10111213, 0x14151617, 0x18191a1b, 0x1c1d1e1f, 
...
const roundKeys = aes256.computeRoundKeys(key);
for (let i = 0; i < expectedRoundKeys.length; i++) {
  if (expectedRoundKeys[i] !== roundKeys[i]) {
